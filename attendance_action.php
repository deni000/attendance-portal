...
if(isset($_POST["action"]))
{
	if($_POST["action"] == "fetch")
	{
		...
		WHERE attendance_tbl.teacher_id = '".$_SESSION["teacher_id"]."' AND (
		";

		if(isset($_POST["search"]["value"]))
		{
			$query .= '
			student_tbl.student_name LIKE "%'.$_POST["search"]["value"].'%" 
	...
	if($_POST["action"] == "Add")
	{
		...
		else
		{
			...
			$query = '
			SELECT attendance_date FROM attendance_tbl 
	...
	if($_POST["action"] == "index_fetch")
	{
		...
		{
			$query .= '
			ORDER BY student_tbl.student_roll_no ASC 
			';
		}

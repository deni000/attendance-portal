        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <div class="row">
              ...
              <div class="col-md-8">
                <input type="text" name="student_roll_no" id="student_roll_no" class="form-control" />
                <span id="error_student_roll_no" class="text-danger"></span>
              </div>
            </div>
          </div>
          <div class="form-group">
		...
		$.ajax({
			...
			success:function(data)
			{
				...
				if(data.error)
				{
					...
					{
						$('#error_student_roll_no').text(data.error_student_roll_no);
					}
					else
					{
						$('#error_student_roll_no').text('');

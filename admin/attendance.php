...
$(document).ready(function(){
  ...
  $('#create_report').click(function(){
    ...
    if(class_id == '')
    {
      $('#error_class_id').text('Semester is Required');
      error++;
    }
    else
    {
  ...
  $('#create_chart').click(function(){
    var class_id = $('#chart_class_id').val();
    var attendance_date = $('#attendance_date').val();
    var error = 0;
    if(class_id == '')
    {
      $('#error_chart_class_id').text('Semester is Required');
      error++;
    }
    else
    {
    ...
    if(error == 0)
    {
      ...
      $('#chart_class_id').val('');
      $('#chartModal').modal('show');
      window.open("chart1.php?action=attendance_report&class_id="+class_id+"&date="+attendance_date);
    }
